...
class ItemByLikeWidget extends StatefulWidget {
  final ProductResponse product;

  const ItemByLikeWidget({Key? key, required this.product}) : super(key: key);

  @override
  _ItemByLikeWidgetState createState() => _ItemByLikeWidgetState();
}

class _ItemByLikeWidgetState extends State<ItemByLikeWidget> {
  @override
